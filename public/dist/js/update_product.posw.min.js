 ...
 */
!function(){"use strict";document.querySelector('div.form-file input[type="file"]').addEventListener("change",(e=>{e.target.nextElementSibling.innerText=e.target.files[0].name}));const e=document.querySelector("div#magnitude-price");document.querySelector("a#add-form-input-magnitude-price").addEventListener("click",(t=>{t.preventDefault(),function(e){const t=document.createElement("div");t.classList.add("mt-3"),t.innerHTML='<div class="input-group">\n        <input class="form-input" type="text" placeholder="Besaran..." name="product_magnitudes[]">\n        <input class="form-input" type="number" placeholder="Harga..." name="product_prices[]">\n        <a class="btn btn--gray-outline" id="remove-form-input-magnitude-price" href="#">Hapus</a>\n    </div>',e.append(t)}(e)})),e.addEventListener("click",(e=>{const t=e.target;if("remove-form-input-magnitude-price"===t.getAttribute("id"))if(e.preventDefault(),void 0!==t.dataset.productPriceId){const e=document.querySelector("main.main").dataset.csrfName,n=document.querySelector(`input[name=${e}]`),a=n.value,r=t.dataset.productPriceId,i=document.querySelector("div.loading-bg");i.classList.remove("d-none"),fetch("/admin/hapus_harga_produk",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded","X-Requested-With":"XMLHttpRequest"},body:`${e}=${a}&product_price_id=${r}`}).finally((()=>{i.classList.add("d-none")})).then((e=>e.json())).then((e=>{if(void 0!==e.csrf_value&&(n.value=e.csrf_value),"success"===e.status)t.parentElement.parentElement.remove();else if("fail"===e.status){const t=function(e,t){const n=document.createElement("div");n.classList.add("alert");for(const t of e)n.classList.add(t);return n.innerHTML=`<span class="alert__icon"></span>\n    <p>${t}</p>\n    <a class="alert__close" href="#"></a>`,n}(["alert--warning","mb-3"],e.message);document.querySelector("main.main > div > div > div").insertBefore(t,document.querySelector("div.main__box"))}})).catch((e=>{console.error(e)}))}else t.parentElement.parentElement.remove()}))}();
